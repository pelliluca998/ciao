      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            {!! Form::select('id_tipopagamento', TipoPagamento::where('id_oratorio', Session::get('session_oratorio'))->orderBy('label', 'ASC')->pluck('label', 'id'), '', ['class' => 'form-control'])!!}
          </div>
          ...
          <div class="form-group">
            ...
            {!! Form::select('id_modalita', ModoPagamento::where('id_oratorio', Session::get('session_oratorio'))->orderBy('label', 'ASC')->pluck('label', 'id'), '', ['class' => 'form-control'])!!}
          </div>

          <div class="form-group">
            {!! Form::label('id_cassa', 'Cassa') !!}
            {!! Form::select('id_cassa', Cassa::where('id_oratorio', Session::get('session_oratorio'))->orderBy('label', 'ASC')->pluck('label', 'id'), '', ['class' => 'form-control'])!!}
          </div>

          <div class="form-group">
            {!! Form::label('importo', 'Importo (€)') !!}
            {!! Form::number('importo', 0, ['step' => '0.01', 'min' => '0', 'class' => 'form-control']) !!}
          </div>

          <div class="form-group">
            {!! Form::label('direzione', 'Entrata o Uscita?') !!}<br>
            {!! Form::radio('direzione', 'entrata', 1, []) !!} Entrata {!! Form::radio('direzione', 'uscita', 0, []) !!} Uscita
          </div>
