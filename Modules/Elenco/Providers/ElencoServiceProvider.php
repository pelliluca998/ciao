...
namespace Modules\Elenco\Providers;
...
class ElencoServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('elenco.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'elenco'
        );
    }
    ...
    {
        $viewPath = base_path('resources/views/modules/elenco');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/elenco';
        }, \Config::get('view.paths')), [$sourcePath]), 'elenco');
    }
    ...
    {
        $langPath = base_path('resources/lang/modules/elenco');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'elenco');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'elenco');
        }
    }
