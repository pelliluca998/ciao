  ...
  <div class="row">
		<div class="col">
			<div class="card bg-transparent border-0">
				<h1><i class='far fa-file-alt'></i> Report anagrafica</h1>

				<p class="lead">Attraverso questa pagina puoi stampare il report con le informazioni dei tui utenti. Oltre a quelle di base, puoi scegliere quali informazioni inserire nel report.</p>
				<hr>
			</div>
		</div>
	</div>
